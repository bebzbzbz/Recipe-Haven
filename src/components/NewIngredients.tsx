...
const NewIngredients = () => {
    ...
    return (  
        <form onSubmit={insertIngredients} className="grid grid-cols-2 items-center gap-3">
            ...
            <fieldset className="col-span-2 text-center">
                    <Button text="Save ingredients" title="Save ingredients" buttonType="submit" bgColor="bg-amber-600" hoverBgColor="hover:bg-amber-500"/>
                </fieldset>
        </form>
    );
}
